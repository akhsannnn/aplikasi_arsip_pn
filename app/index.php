    ...
    <header class="bg-court-green text-white shadow-lg z-20 shrink-0">
        <div class="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                <a href="template_manager.php" class="text-xs bg-gray-700 text-white px-3 py-1.5 rounded hover:bg-gray-600 transition shadow" title="Kelola Template Folder">
                    <i class="fa-solid fa-cog mr-1"></i> Template
                </a>
